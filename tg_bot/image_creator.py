...
async def get_stats_img():
    ...
    title_font = ImageFont.truetype('Inter-regular.ttf', 23)
    title_font_bold = ImageFont.truetype('Inter-Bold.ttf', 23)
    bit_bigger_font = ImageFont.truetype('Inter-Bold.ttf', 30)
    bigger_font = ImageFont.truetype('Inter-Bold.ttf', 36)
    smaller_font = ImageFont.truetype('Inter-regular.ttf', 20)
    smallest_font = ImageFont.truetype('Inter-regular.ttf', 14)
