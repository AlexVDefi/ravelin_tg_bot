...
async def get_stats_img():
    ...
    title_font = ImageFont.truetype(filepath_files+'/Inter/Inter-regular.ttf', 23)
    title_font_bold = ImageFont.truetype(filepath_files+'/Inter/Inter-Bold.ttf', 23)
    ...
    smallest_font = ImageFont.truetype(filepath_files+'/Inter/Inter-regular.ttf', 14)
